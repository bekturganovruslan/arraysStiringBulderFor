...
// ************** Method 1******************
    ...
    public StringBuilder getAllDetails() {
        ...
        for (int i = 0; i < ITEMS.length; i++) {
            result.append(ITEMS[i]).append("-").append(PRICES[i]).append("-").append(INVENTORYNUM[i]).append("\n");
        }
        return result;
...
public double findItemPrice(String item){
    ...
    public static void main(String[] args) {
        ...
        System.out.println(tech.getAllDetails());
        System.out.println(tech.findItemPrice("Gum"));
    }
